...
-- AddForeignKey
ALTER TABLE `network_history` ADD CONSTRAINT `network_history_account_id_fkey` FOREIGN KEY (`account_id`) REFERENCES `accounts`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `article_versions` ADD CONSTRAINT `article_versions_editor_id_fkey` FOREIGN KEY (`editor_id`) REFERENCES `accounts`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
